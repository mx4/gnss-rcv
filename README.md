...
| ↳ same capture, **Galileo E1-B** | (as above) | `… --sig E1B` | ✅ **52.148, 4.460** — Galileo-only fix, 5 SVs (E01/E04/E09/E11/E19), ~4 km from the GPS truth |
...
- [x] Galileo E1 — **acquires + tracks + decodes I/NAV + extracts the ephemeris +
      ...
      4.488, Netherlands)** — within the open per-SV ~0.5 ms pseudorange bias. The
      decoder is resilient to the Costas half-symbol-rate (±125 Hz) false lock that
      had silently corrupted the symbol stream of 3 of the 5 SVs
- [ ] BeiDou B1
