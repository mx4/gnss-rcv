...
RECORDINGS: List[Rec] = [
    ...
    Rec("ion-gn3s",
        ...
        "-t i8 --fs 16368000 --fi 4092000",
        "ION GN3S (SiGe) L1, real 8-bit IF 4.092 MHz, ~120s (Munich 2013); GPS L1 C/A -- GN3S ~2 MHz BW too narrow for E1", ("gps",)),
    Rec("sjtu",
    ...
    Rec("ion-ifen",
        ...
        "-t 2bit --fs 20480000 --fi 5500000",
        "ION IFEN SX3 dual-RF L1, real 2-bit IF 5.5 MHz, 10 MHz BW, ~18 min (Munich 2016, 5.7 GiB); GPS L1 + 4 Galileo E1 (E11/E12/E19/E20). Uses the new 2-bit reader -- bit-order not yet confirmed against a live acquire", ("gps", "galileo")),
    Rec("pocketsdr",
