//! GPS L1 C/A (and QZSS) LNAV decoding: 50 bps bit sync, frame sync on the 0x8B
//! preamble, the 30-bit-word Hamming parity, and the subframe-1..5 parsers that
//! fill the ephemeris/almanac. Driven from the generic `Channel::nav_decode`
//! dispatch in [navigation](crate::navigation).
